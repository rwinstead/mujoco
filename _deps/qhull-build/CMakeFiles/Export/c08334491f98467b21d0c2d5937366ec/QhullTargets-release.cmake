...
set_target_properties(Qhull::qhull PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qhull.so"
  )

list(APPEND _cmake_import_check_targets Qhull::qhull )
list(APPEND _cmake_import_check_files_for_Qhull::qhull "${_IMPORT_PREFIX}/bin/qhull.so" )
...
set_target_properties(Qhull::rbox PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/rbox.so"
  )

list(APPEND _cmake_import_check_targets Qhull::rbox )
list(APPEND _cmake_import_check_files_for_Qhull::rbox "${_IMPORT_PREFIX}/bin/rbox.so" )
...
set_target_properties(Qhull::qconvex PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qconvex.so"
  )

list(APPEND _cmake_import_check_targets Qhull::qconvex )
list(APPEND _cmake_import_check_files_for_Qhull::qconvex "${_IMPORT_PREFIX}/bin/qconvex.so" )
...
set_target_properties(Qhull::qdelaunay PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qdelaunay.so"
  )

list(APPEND _cmake_import_check_targets Qhull::qdelaunay )
list(APPEND _cmake_import_check_files_for_Qhull::qdelaunay "${_IMPORT_PREFIX}/bin/qdelaunay.so" )
...
set_target_properties(Qhull::qvoronoi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qvoronoi.so"
  )

list(APPEND _cmake_import_check_targets Qhull::qvoronoi )
list(APPEND _cmake_import_check_files_for_Qhull::qvoronoi "${_IMPORT_PREFIX}/bin/qvoronoi.so" )
...
set_target_properties(Qhull::qhalf PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/qhalf.so"
  )

list(APPEND _cmake_import_check_targets Qhull::qhalf )
list(APPEND _cmake_import_check_files_for_Qhull::qhalf "${_IMPORT_PREFIX}/bin/qhalf.so" )
